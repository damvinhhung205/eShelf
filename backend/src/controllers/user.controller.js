...
export async function findOne(req, res, next) {
  try {
    ...
    return next(
      new ApiError(
        500,
        `An error occurred while retrieving the user with id=${req.params.id}`,
      ),
    );
  }
}
...
export async function update(req, res, next) {
  try {
    ...
    return next(
      new ApiError(
        500,
        `An error occurred while updating the user with id=${req.params.id}`,
      ),
    );
  }
}
...
export async function deleteOne(req, res, next) {
  try {
    ...
    return next(
      new ApiError(
        500,
        `An error occurred while deleting the user with id=${req.params.id}`,
      ),
    );
  }
}
